...
class Presets(object):
    ...
    BLOCK_LIST = ['http://', 'Series', 'series', 'money heist', 'Money Heist', 'vikings', 'shang chi', 'Shang chi', 'Shangchi', 'Vikings', 'loki', 'Loki', 'season', 'Season', 'Episode', 'episode', 'https://', '@', '#', 'bit.ly', 't.me', '/']
