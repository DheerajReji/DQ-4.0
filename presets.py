...
class Presets(object):
    CAPTION_TEXT_DOC = "\n\n<b>File Name:</b> {}\n\n<b>Format:</b> {}\n<b>Size:</b> {}"
    CAPTION_TEXT_VID = "\n\n<b>File Name:</b> {}\n\n<b>Size:</b> {}"
    ASK_PM_TEXT = "<b>നിങ്ങൾ ചോദിച്ച <b>{}</b> മൂവി ലഭിക്കാൻ താഴെ കാണുന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക</b>"
    ...
    PM_ERROR = "<b>ചില സാങ്കേതിക തകരാറുകൾ മൂലം <b>{}</b> മൂവി ലഭ്യമല്ല 😞</b>\n"
               "</code>അൽപ്പസമയത്തിനു ശേഷം മൂവി ഒരു പ്രാവശ്യം കൂടി ചോദിക്കുക!</code>"
    MEDIA_SEND_TEXT = "<code><b>{}</b> മൂവിയുടെ ഫയലുകൾ PM ൽ അയച്ചിട്ടുണ്ട്</code>"
